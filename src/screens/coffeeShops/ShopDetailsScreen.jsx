...
export default class ShopDetailsScreen extends ValidationComponent {
  ...
  favouriteLocation() {
    // check user object if location id is in
    // favourite_locations, set this.state.checked based on result
    let httpMethod = 'post';
      ...
      <View style={{ flex: 1, backgroundColor: '#845D3E' }}>
        ...
        <View style={{ flex: 3, justifyContent: 'center' }}>
          ...
          <View style={commonStyles.ratingItemStyle}>
            <Text>
              ...
              {this.state.shopData.avg_overall_rating}
            </Text>
          ...
          <View style={commonStyles.ratingItemStyle}>
            <Text>
              ...
              {this.state.shopData.avg_price_rating}
            </Text>
            <Icon name="star" size={20} type="MaterialCommunityIcons" />
          </View>
          ...
          <View style={commonStyles.ratingItemStyle}>
            <Text>
              ...
              {this.state.shopData.avg_quality_rating}
            </Text>
            <Icon name="star" size={20} type="MaterialCommunityIcons" />
          </View>
          ...
          <View style={commonStyles.ratingItemStyle}>
            <Text>
              ...
              {this.state.shopData.avg_clenliness_rating}
            </Text>
            <Icon name="star" size={20} type="MaterialCommunityIcons" />
          </View>
        </View>
        ...
        <View style={{ flex: 3, flexDirection: 'column', justifyContent: 'center' }}>
          ...
          <Button
            ...
            onPress={() => this.navigateToShopReviews()}
          />
        </View>
      </View>
    );
