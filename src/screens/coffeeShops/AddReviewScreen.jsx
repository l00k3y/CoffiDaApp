...
import { Button, Image, Divider, CheckBox, Header, AirbnbRating, Input } from 'react-native-elements';
      ...
      <View style={commonStyles.mainView}>
        ...
        <View style={commonStyles.mainContentView}>
          ...
          <View style={{flex: 3}}>
            ...
            <Button title="Add Photo" buttonStyle={{ width: '100%', backgroundColor: '#ECD2C7', marginTop:'5%' }}
              titleStyle={{ color: '#36222D', textAlign: 'center' }} onPress={() => console.log("takePhoto")}
          />
          </View>
        </View>
      </View>
